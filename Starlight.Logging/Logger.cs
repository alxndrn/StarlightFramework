    ...
    public static class Logger
    {
        ...
        static Logger()
        {
            ...
            if (loggingSettings != null && loggingSettings.IsEnabled)
            {
                ...
                {
                    loggerConfiguration.WriteTo.File("starlight-log.txt", rollingInterval: RollingInterval.Day, outputTemplate: loggingSettings.OutputTemplate);
                }
            }
