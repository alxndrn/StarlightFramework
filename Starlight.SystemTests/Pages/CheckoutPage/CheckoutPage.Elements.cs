...
namespace Starlight.SystemTests.Pages.CheckoutPage
{
    public partial class CheckoutPage
    {
        ...
        public Span ReceivedMessage => ElementCreateService.CreateByXPath<Span>("//h1[contains(text(), 'Order received')]");

        public Button GetCountryOptionByName(string countryName)
        {
            return ElementCreateService.CreateByXPath<Button>($"//li[contains(text(),'{countryName}')]");
        }
    }
}
